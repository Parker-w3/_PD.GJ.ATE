...
namespace GJ.Para.Udc.HIPOT
{
    public partial class udcHPPara : UserControl
    {
        ...
        #region 字段
        private CHPSetting.CStep step = new CHPSetting.CStep(); 
        #endregion

        #region 属性
        public CHPSetting.CStep mStep
        {
            get { return step; }
        }
        #endregion
        ...
        #region 方法
        public void setItem(CHPSetting.CStep stepItem)
        {
            step = stepItem;
            if (panelStep != null)
            {
            ...
            panelStep.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,160));
            panelStep.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute,120));
            panelStep.ColumnStyles.Add(new ColumnStyle(SizeType.Percent,80));
            ...
            for (int i = 0; i < itemNum; i++)
            {
                ...
                labStepName[i].Text = step.para[i].name+":";
                ...
                labStepDes[i].Text = step.para[i].unitDes;
