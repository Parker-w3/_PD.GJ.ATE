...
using GJ;
using GJ.Para.UNLOAD ;
using GJ.Para.Base;

namespace GJ.Para.Udc.RRCC
{
    public partial class udcRRCCinfo : UserControl
    {
        ...
        public void ShowModel(CModelPara modelPara)
        {
            ...
            else
            {
                ...
                labVHZ.Text = "电压：" + modelPara.LCRVolt + "V" + "   ;   " + "频率" + modelPara.LCRHZ + "HZ";
                labCCSpec.Text = modelPara.CCMin.ToString() + " -- " + modelPara.CCMax.ToString();
                labRRSpec.Text = modelPara.RRMin.ToString() + " -- " + modelPara.RRMax.ToString();
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            labVHZ.Text = "电压：" + runModel .LCRVolt + "V" + "   ;   " + "频率" + runModel .LCRHZ + "HZ";
            labCCSpec.Text = runModel.CCMin.ToString() + " -- " + runModel.CCMax.ToString();
            labRRSpec.Text = runModel.RRMin.ToString() + " -- " + runModel.RRMax.ToString();

          //  CIniFile.WriteToIni("Parameter", "Model", dlg.FileName, iniFile);
            CIniFile.WriteToIni("Parameter", "RRCC", dlg.FileName, iniFile);
        ...
        private void label7_DoubleClick(object sender, EventArgs e)
        {
            if (labTTNum.Visible)
            {
                ...
                labVHZ.Visible = false;
                labCCSpec.Visible = false;
                labRRSpec.Visible = false;
            ...
            else
            {
                ...
                labVHZ.Visible = true;
                labCCSpec.Visible = true;
                labRRSpec.Visible = true;
